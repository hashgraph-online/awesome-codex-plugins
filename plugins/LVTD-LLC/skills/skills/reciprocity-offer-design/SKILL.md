...
metadata:
  version: "0.1.0"
  displayName: Reciprocity Offer Design
  category: Marketing
  tags: influence,persuasion,reciprocity,offers
---
...
2. Load `references/reciprocity/knowledge.md` for concepts and `references/reciprocity/rules.md` for operating rules.
3. Use `workflows/design-value-first-offer.md` for repeatable tasks.
