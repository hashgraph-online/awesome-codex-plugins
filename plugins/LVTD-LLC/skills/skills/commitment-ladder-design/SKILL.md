---
name: commitment-ladder-design
description: Use when designing or auditing onboarding, activation flows, habit loops, pledges, public commitments, progressive profiling, retention programs, behavior-change plans, pricing flows, or lowball-risk funnels where consistency pressure may shape user decisions.
license: MIT
metadata:
  version: "0.1.0"
  displayName: Commitment Ladder Design
  category: Marketing
  tags: influence,persuasion,commitment,onboarding
---
