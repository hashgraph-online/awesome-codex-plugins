...
metadata:
  version: "0.1.0"
  displayName: Ethical Persuasion Design
  category: Marketing
  tags: influence,persuasion,ethics,copywriting
---
...
2. Load `references/persuasion/knowledge.md` for concepts and `references/persuasion/rules.md` for operating rules.
3. Use `workflows/design-persuasive-request.md` for repeatable tasks.
