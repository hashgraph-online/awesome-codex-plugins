...
Auto-installs the binary and seeds the PreToolUse hook on next session start — no additional setup required.
...
The PreToolUse hook is registered automatically — no further steps needed.
