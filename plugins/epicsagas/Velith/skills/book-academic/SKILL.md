---
name: book-academic
description: "Academic writing patterns — IMRAD structure, literature review, argument chains, citation practices, thesis/dissertation layout."
---

# Academic Writing Patterns

**Structure types by discipline**:
- Sciences: IMRAD — Introduction → Methods → Results → Discussion
- Social sciences: Modified IMRAD + Theory Framework + Literature Review
- Humanities: Thesis → Evidence chapters → Synthesis → Conclusion
- Thesis/Dissertation: Abstract → Introduction → Background/Lit Review → Methodology → Results/Findings → Discussion → Conclusion → References → Appendices
