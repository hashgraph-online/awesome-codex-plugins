...
<p align="center">
  <img src="docs/assets/nullcost-vs-without-benchmark.png" alt="Nullcost speed and token comparison against normal pricing-page browsing">
</p>
...
Nullcost can show reviewed community referral, affiliate, and credit codes next
to the official provider link. The point is not to sell the top slot; it is to
let builders share real signup benefits with the next person choosing a tool.

<p align="center">
  <img src="docs/assets/nullcost-community-code-loop.png" alt="Users submit referral and affiliate codes so the Nullcost community gets reviewed savings">
</p>
