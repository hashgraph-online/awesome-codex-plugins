...
`$beads-br` (plan → beads conversion, absorbed from beads-workflow). The miner stops there.
...
- [beads-br](../beads-br/SKILL.md) — lands accepted candidates on the tracker (plan → beads conversion)
