Feature: Validate returns one fresh judgment over exact content
  @covered-by:skills/validate/tests/test_validate.py::test_verdict_identity_floor_and_idempotence
  ...
  @covered-by:skills/validate/tests/test_validate.py::test_pass_without_evidence_is_downgraded
  ...
  @covered-by:skills/validate/tests/test_validate.py::test_runtime_scope_failure_forces_fail
  ...
  @covered-by:skills/validate/tests/test_validate.py::test_intent_snapshot_is_content_addressed_and_idempotent
