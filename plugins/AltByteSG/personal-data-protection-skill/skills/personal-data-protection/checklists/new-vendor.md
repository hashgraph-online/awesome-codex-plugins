...
| **Vietnam PDPL** | No adequacy list and no SCC regime. Any vendor processing Vietnamese personal data outside Vietnam is a **cross-border transfer** under Điều 20(1), requiring a transfer impact assessment **filed within 60 days of first transfer** (Điều 20(2)) and refreshed 6-monthly (Điều 22) — so vendor onboarding changes a filed regulatory document, not just a DPA. The authority may inspect yearly and **order transfers suspended** (Điều 20(4)–(5)). Điều 37(1)(đ) makes selecting an appropriate processor a named controller duty, and the vendor's breach notice must reach you fast enough to meet a **72-hour clock that runs from detection**. |
