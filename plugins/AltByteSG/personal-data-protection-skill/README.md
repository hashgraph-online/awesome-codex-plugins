...
| Vietnam | Law on Personal Data Protection 91/2025/QH15 + Decree 356/2025/NĐ-CP | A05 (MPS) | ✅ Populated |
...
## How the six statutes diverge — developer view
...
- `vn-pdpl` — Vietnam Law on Personal Data Protection 91/2025/QH15
...
- **Law No. 91/2025/QH15**, passed 26 June 2025, **in force 1 January 2026**. 39 articles across 5 chapters.
- **Decree 356/2025/NĐ-CP**, promulgated 31 December 2025 — the guiding decree, 42 articles. Replaced Personal Data Protection Decree 13/2023/NĐ-CP.
- **Regulator:** `cơ quan chuyên trách bảo vệ dữ liệu cá nhân`, the specialised authority under the **Ministry of Public Security** (A05). Vietnam enforces through the MPS, not an independent DPA.
- **Binding text is Vietnamese.** No official English translation was available at the last verification date — see the translation caveat in [`vn-pdpl/README.md`](skills/personal-data-protection/jurisdictions/vn-pdpl/README.md).
...
- Stack-specific implementation examples for the layer files
