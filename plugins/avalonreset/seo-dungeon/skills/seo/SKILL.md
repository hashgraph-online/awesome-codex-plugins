...
launcher path. In Dungeon, `python <absolute-engine-root>/scripts/runtime.py`
with the same arguments is the cross-platform launcher equivalent. Never invoke
the analysis scripts themselves with a bare Python interpreter.
