...
[![Version](https://img.shields.io/badge/version-3.30.1-blue.svg)](CHANGELOG.md)
...
[![Cowork](https://img.shields.io/badge/cowork-team%20persistent-purple.svg)](#supported-surfaces-v3301)
...
Yes — verified-real native manifests ship for all 8 surfaces (CC, Cowork, Codex, Cursor, Copilot CLI, Antigravity, Hermes Agent, OpenClaw). See [Supported surfaces](#supported-surfaces-v3301) above for per-platform install commands.
