...
```bash
pipx install --force "plugin-scanner==3.0.120"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `e284b8f132568e815c765188da06e931e5494b4866b70d6e3155dff451fc903c`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==3.0.120"
