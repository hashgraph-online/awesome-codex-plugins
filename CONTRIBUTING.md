...
```bash
pipx install --force "plugin-scanner==3.0.66"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `d9911b8daedea98daf25b3c35217e9c36c26da1dc9869102f447401ff3f5b655`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==3.0.66"
