...
```bash
pipx install --force "plugin-scanner==3.0.140"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `7e0f3b006fe1d94e6bfc07ad94f64c8348cbbd39279bac73576553be4668e03b`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==3.0.140"
