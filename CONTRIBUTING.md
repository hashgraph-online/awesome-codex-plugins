...
```bash
pipx install --force "plugin-scanner==3.0.128"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `169679d2ca29af74bb04fa6f3a47eafafe5c75287916ed709420dc6346a8e61f`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==3.0.128"
