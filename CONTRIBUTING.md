...
```bash
pipx install --force "plugin-scanner==3.0.57"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `a3bff20c5fca6ac85e87e4aad3919b69d72864cf822c2dff44d0f267b4e63c22`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==3.0.57"
