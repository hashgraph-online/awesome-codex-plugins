...
```bash
pipx install --force "plugin-scanner==3.0.153"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `24ef86abac32db5b8ca2f73e84fa76c46fd758c95d74d1cd5d1e1a73f4e8cdb1`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==3.0.153"
