...
```bash
pipx install --force "plugin-scanner==3.0.132"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `a3e79a8f3ca9c101236a2460e6ef741abeec153d82f5e78dca3af12dec8d98eb`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==3.0.132"
