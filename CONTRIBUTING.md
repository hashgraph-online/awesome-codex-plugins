...
```bash
pipx install --force "plugin-scanner==3.0.154"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `96518e3355f6dd8d9762cf4f3c6cfd0f9340da15b87a39c0e0c225fc43ff46be`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==3.0.154"
