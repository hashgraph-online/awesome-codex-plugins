...
```bash
pipx install --force "plugin-scanner==3.0.152"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `375312e3f7d8f3851cea6af137360cdda6241809c334f99f325c76349822ec37`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==3.0.152"
