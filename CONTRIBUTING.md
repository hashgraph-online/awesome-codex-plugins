...
```bash
pipx install --force "plugin-scanner==3.0.138"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `619dcc0083a6b1c23f0ea769e97ff06d2c048fc65366f5d3eb76d58f533282fb`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==3.0.138"
