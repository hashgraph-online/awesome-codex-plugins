...
```bash
pipx install --force "plugin-scanner==3.0.155"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `68c0efe46fb3d2124d8f2f3e36eb2de42d5a426f47bbc19d17d84cef86b7f869`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==3.0.155"
