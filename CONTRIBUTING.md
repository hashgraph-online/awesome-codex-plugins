...
```bash
pipx install --force "plugin-scanner==2.0.1116"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `40d40308484e49b438c6ef47a7794ab6aac617914447174f80fe4578911cdcb3`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==2.0.1116"
