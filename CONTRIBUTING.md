...
```bash
pipx install --force "plugin-scanner==3.0.157"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `8771eb29af14e39d54c039eab6f9819c71457db177f606502cc0011885131062`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==3.0.157"
