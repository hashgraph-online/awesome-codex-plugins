...
```bash
pipx install --force "plugin-scanner==3.0.141"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `0079bd3c648f24eea41777514f8709ad21f8659b79de0901b064a2357700e4e4`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==3.0.141"
