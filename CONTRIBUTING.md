...
```bash
pipx install --force "plugin-scanner==3.0.156"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `e1aac54fe1f85de5b5a615582ac8b17af321005a29004861abf6fc017a6a00b8`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==3.0.156"
