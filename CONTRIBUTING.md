...
```bash
pipx install --force "plugin-scanner==2.0.908"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `24a1318a9798789090bd860c28e3ad82f5106ebfabcff0da4d038637377fe08c`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==2.0.908"
