...
```bash
pipx install --force "plugin-scanner==3.0.137"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `72bbdcd90f4ffd946e5a60c78863fc30fc2964ac0025524dc36d40458348e487`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==3.0.137"
