...
```bash
pipx install --force "plugin-scanner==3.0.149"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `502ffc5911f453d403d20616d94823504075078b51c884e89100856dcefdc774`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==3.0.149"
