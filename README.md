...
- [Vanguard Frontier Agentic](https://github.com/Raishin/vanguard-frontier-agentic) - Enterprise-grade agentic workflow marketplace with cloud, zero-trust, compliance, ERP, and platform specialist agents, skills, MCP references, and live-mutation guardrails across Codex and other coding agents.
