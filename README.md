...
2. **Validate with [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard)** â€” **Required: score â‰¥ 80, no high/critical findings**
3. **Gate PRs with the [HOL scanner GitHub Action](https://github.com/hashgraph-online/ai-plugin-scanner-action)** â€” **Required for listing**
...
1. Open Codex settings â†’ Plugins â†’ Next to search plugins input click on menu and select â†’ `+Add More...`
...
<details>
<summary>Curated by OpenAI â€” available in the built-in Codex Plugin Directory</summary>
...
- [Agent Workflow System](https://github.com/1139030773-cmd/agent-workflow-system) - ä¸€å¥—ä¸­æ–‡AIå·¥ä½œæµç³»ç»Ÿï¼š7ä¸ªåä½œæŠ€èƒ½ + è¡Œä¸ºè§„èŒƒå®ªæ³• + ä¼šè¯æ¢å¤æœºåˆ¶ï¼Œæ¨¡ç³Šç›®æ ‡â†’å¯æ‰§è¡Œä»»åŠ¡ï¼Œå…¨ç”Ÿå‘½å‘¨æœŸå¼•å¯¼ã€‚Codex & Claude Code åŒå¹³å°ï¼Œæ–°æ‰‹å‹å¥½ã€‚
...
- [Antigravity Workspace Template](https://github.com/study8677/antigravity-workspace-template) - Multi-agent codebase knowledge graph generator with context-aware planning and automatic scope management â€” turns codebases into coherent agent workspaces.
- [Archcore](https://github.com/archcore-ai/plugin) - Gives coding agents the architecture, rules, and prior decisions of the repo via skills, hooks, and MCP â€” so new changes land where the project says they belong across Claude Code, Cursor, and Codex CLI.
...
- [Brooks Lint](https://github.com/hyhmrright/brooks-lint) - AI code reviews grounded in six classic engineering books â€” decay risk diagnostics with book citations, severity labels, and four analysis modes (PR review, architecture audit, tech debt, test quality).
- [Casefile](https://github.com/x4cc3/casefile) - Persistent security case tracking for bug bounties, CTFs, and security audits.
- [Changelog Forge](./plugins/mturac/changelog-forge) - Conventional commits â†’ CHANGELOG section + semver bump.
...
- [Claude Code Skills](https://github.com/alirezarezvani/claude-skills) - 223 production-ready skills, 23 agents, and 298 Python tools across 9 domains â€” engineering, marketing, product, compliance, and more.
...
- [Codebase Recon](https://github.com/yujiachen-y/codebase-recon-skill) - Analyze git history to understand a codebase before reading any code â€” auto-scales by repo size and cross-references hotspots with bug magnets to surface high-risk files, bus factor, and team momentum.
...
- [Env Lint](./plugins/mturac/env-lint) - `.env` vs `.env.example` key parity â€” never prints values.
- [Epic Harness](https://github.com/epicsagas/epic-harness) - Auto-trigger quality skills + self-evolving agent harness â€” orbit (spec-to-ship), evolve (skill mutation), team (multi-agent), TDD, check, ship, simplify, debug, perf, secure.
...
- [Honcho](https://github.com/plastic-labs/codex-honcho) - Persistent cross-session memory for Codex powered by Honcho â€” lifecycle hooks capture each session and inject relevant context back at session start, so Codex remembers your preferences, projects, and decisions across restarts.
...
- [Personal Data Protection](https://github.com/AltByteSG/personal-data-protection-skill) - Engineer-facing personal-data-protection compliance reference â€” Singapore PDPA, Thailand PDPA, Indonesia UU PDP, Malaysia PDPA (Act 709 + 2024 Amendments), Philippines DPA â€” organised by where in the stack each obligation lands, with checklists, breach-response runbook, and a developer-view divergence table across all five.
...
- [Runtype Skills](https://github.com/runtypelabs/skills) - Supercharge your coding agent for AI product development â€” build, deploy, and operate agents, flows, tools, and surfaces on Runtype's managed edge runtime.
...
- [Session Orchestrator](https://github.com/Kanevry/session-orchestrator) - Session orchestration for Claude Code, Codex, and Cursor IDE â€” structured planning, wave-based execution, VCS integration (GitLab + GitHub), quality gates, and clean session close-out with issue tracking.
...
- [Spec-Driven Development](https://github.com/Habib0x0/spec-driven-plugin) - Three-phase Requirements â†’ Design â†’ Tasks workflow for Claude Code and Codex â€” EARS notation acceptance criteria, autonomous execution loop, cross-spec dependencies, and post-implementation acceptance testing.
...
- [Team Skills Platform](https://github.com/Colin4k1024/tsp) - Role-based team delivery framework â€” Tech Lead-orchestrated 8-role system with 195+ skills, 27 specialist agents, 80+ commands, hooks, and ECC harness for Claude Code, Codex, and OpenCode.
...
- [VibePortrait](https://github.com/dadwadw233/VibePortrait) - Developer personality portrait generator â€” analyzes AI conversation history to produce MBTI type (16 color themes), capability radar, developer rating, 3-dimension famous match, and a persona skill that lets any AI "think like you".
...
- [Workflow Kit](https://github.com/Le-Xuan-Thang/workflow-kit) - Full product lifecycle plugin for Claude Code, Codex CLI, and OpenCode: define Vision/Mission/Core â†’ generate workplan â†’ execute with mandatory cross-provider reviewer agents â†’ synthesize deliverables â†’ maintain, with parallel task execution, crash recovery, and AgentOps metrics.
...
- [Digital Marketing Pro](https://github.com/indranilbanerjee/digital-marketing-pro) - Open-source AI marketing plugin for agencies â€” 154 skills, 25 specialist agents, 12-Part Strategy Flow, AEO/GEO, GSC AI Performance Report, Google Ads API v24, EU AI Act Article 50 / C2PA compliance.
...
- [Mantis](./plugins/deonmenezes/mantishack) - Autonomous bug bounty hunter for authorized engagements â€” 7-phase FSM (RECON â†’ AUTH â†’ HUNT â†’ CHAIN â†’ VERIFY â†’ GRADE â†’ REPORT), parallel hunter sub-agents, cryptographic scope enforcement, and BLAKE3/Ed25519 Merkle event logs.
...
- [Mobazha](https://github.com/mobazha/mobazha-skills) - Decentralized e-commerce skills â€” deploy self-hosted stores, import products from Shopify/Amazon, configure custom domains and Telegram bots, set up Tor privacy, and manage your store via MCP.
...
- [ru-text](https://github.com/talkstream/ru-text) - Russian text quality â€” ~1,044 rules for typography, info-style, editorial, UX writing, and business correspondence.
...
- [sitemd](https://github.com/sitemd-cc/sitemd) - Build websites from Markdown via MCP â€” 22 tools for creating pages, generating content, validating, running SEO audits, configuring settings, and deploying static sites to Cloudflare Pages.
...
- [unslop](https://github.com/MohamedAbdallah-14/unslop) - Strip AI writing patterns from text output â€” removes filler phrases, hedging language, and generic constructs to produce cleaner written content. Install: `npm install -g unslop`.
...
- [Val Town](https://github.com/val-town/plugins) - Build and deploy serverless TypeScript on Val Town from Codex â€” hosted MCP server plus skills for HTTP vals, cron, SQLite, email, OAuth, and React UI.
...
- [WakeWire](https://github.com/glenncalleja/wakewire) - Push events from GitHub, Gmail, Slack, and any signed webhook (Linear, Sentry, ClickUp) straight into your Codex threads as new turns â€” event-driven triggers instead of polling, with HMAC verification, deduplication, and a durable delivery queue.
...
my-plugin/
â”œâ”€â”€ .codex-plugin/
â”‚   â””â”€â”€ plugin.json          # Required: name, version, description, skills path
â”œâ”€â”€ skills/
â”‚   â””â”€â”€ my-skill/
â”‚       â”œâ”€â”€ SKILL.md          # Required: skill instructions + metadata
â”‚       â”œâ”€â”€ scripts/          # Optional: executable scripts
â”‚       â””â”€â”€ references/       # Optional: docs and templates
â”œâ”€â”€ apps/                     # Optional: app integrations
...
3. Authorize the read-only GitHub connection (view your profile, email, and public org membership â€” no write access)
