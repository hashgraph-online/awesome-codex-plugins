...
- [SenderKit](https://github.com/senderkit/senderkit-skills) - Add transactional email, SMS, push, and web-push to any app from your AI coding agent, then create templates, send, and monitor messages over MCP — no provider lock-in.
