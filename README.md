...
- [UIZZE](https://github.com/samuelbushi/uizze) - STOP UI SLOP. Grounds Codex in 800,000+ real web and iOS screens, a product-specific design contract, and a hard finish gate before generic UI ships.
