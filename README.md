...
- [design-helper](https://github.com/Dessert99/design-helper) - Settles CSS values, layout, and motion by eye: draws candidates that differ in one property side by side in the browser, then applies the one you pick to your code.
...
- [Devin Plugin CC](https://github.com/TheOnlyFusionCube/devin-plugin-cc) - Devin AI code reviews, delegated tasks, Fusion lead/sidekick workflows, and cloud handoffs to app.devin.ai for Codex, Claude Code, and other coding agents.
...
- [OrcaReplay](https://github.com/Continuum-AI-Corp/OrcaReplay) - Records a Codex CLI run below the harness — Responses API traffic, tool calls and per-turn file changes — then replays it with the recorded responses served back, or forks it from a checkpoint onto another model.
...
- [Story Skills](https://github.com/danjdewhurst/story-skills) - Fiction-writing skills for planning, drafting, and revising stories as markdown, with a dependency-free CLI that checks continuity: deaths, promise payoffs, open questions, and durable story state.
...
- [Unified AI System](https://github.com/happy520ai/unified-ai-system) - Self-hosted AI gateway for Codex with provider-free prompt enhancement, fifteen governed MCP tools, and a credential-free Docker path.
