...
- [TMCRA Local Memory](https://github.com/reshuibuduo/tmcra-plugin-codex) - Automatic long-term memory for Codex with account-scoped global and project recall, role-separated writeback, lifecycle checkpoints, and local Writer and organizer model settings.
