...
- [deja](https://github.com/vshulcz/deja-vu) - Search the coding sessions already on your disk — Codex, Claude Code, Cursor, opencode and sixteen more — including work from before it was installed, indexed locally with no model in the loop.
