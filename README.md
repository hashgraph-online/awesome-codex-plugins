...
- [UIZZE](https://github.com/uizze/uizze) - Free anti-UI-slop skill and no-account preview MCP for coding agents, with full UIZZE MCP access to 800,000+ real web and iOS screens, design contracts, and a hard finish gate.
