...
- [RunAPI MCP Server](https://github.com/runapi-ai/mcp) - Unified API and MCP server for 130+ AI models across image, video, music, audio, and LLM from 18 providers. Free catalog tools for model discovery and pricing. Install: `npx @runapi.ai/mcp init codex`.
